...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/AJWValidator/AJWValidator.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/KxMenu/KxMenu.framework"
  install_framework "$BUILT_PRODUCTS_DIR/MSWeakTimer/MSWeakTimer.framework"
  install_framework "$BUILT_PRODUCTS_DIR/PopMenu/PopMenu.framework"
  install_framework "$BUILT_PRODUCTS_DIR/RadioButton/RadioButton.framework"
  install_framework "$BUILT_PRODUCTS_DIR/SDWebImage/SDWebImage.framework"
  install_framework "$BUILT_PRODUCTS_DIR/SVProgressHUD/SVProgressHUD.framework"
  install_framework "$BUILT_PRODUCTS_DIR/SwiftyJSON/SwiftyJSON.framework"
  install_framework "$BUILT_PRODUCTS_DIR/XHRealTimeBlur/XHRealTimeBlur.framework"
